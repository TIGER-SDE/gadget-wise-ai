  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-primary text-primary-foreground hover:scale-105 transition-bounce shadow-glow hover:shadow-xl font-semibold",
        glass: "bg-card/20 backdrop-blur-sm border border-border/50 text-foreground hover:bg-card/30 hover:border-accent/50",
        tech: "bg-accent text-accent-foreground hover:bg-accent/90 font-medium shadow-md hover:shadow-glow transform hover:scale-105 transition-bounce",
      },
      size: {
